...
plot(Y[,1], Y[,2], xlab = expression(theta),
     ylab = expression(sigma), main = "GRAFICO DE DISPERSIÓN PARA OMEGA 1",
...
mtext("IDENTIFICACION DE GRUPOS EN LOS DEPARTAMENTOS", side = 3, line = 0.5,
...
plot(hc_result, main = "DENDOGRAMA: AGRUPAMIENTO JERARQUICO", ylab = "DISTANCIA",
...
mtext("METODO DE ELECCIÓN PARA EL NUMERO DE CLUSTERS", side = 3, line = 0.5,
      cex = 0.8, col = "grey20", font = 2)
...
```{r, fig.width=10, fig.height=10}
Colores = c('#d4a243', '#f78a7d', '#f75e57', '#d76ba3', '#b97ac9', '#735bb2', '#4a377e', '#842a54', '#b5573f')
