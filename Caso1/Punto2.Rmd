...
La lista anterior muestra los distintos departamentos con su respectivo codigo, esta, nos ayudara más adelante a verificar cuales son aquellos departamentos con mejor calificación promedio. Luego haciendo uso de la funcion anteriormente creada podemos calcular la media posterior y otros parámetros para cada departamento, y posteriomente identificar los cinco con mejores calificaciones promedio.
...
Antes de graficar los 5 mejores, se puede hacer util tener el grafico del mapa completo de los departamentos sin diferenciar a los 5 mejores como se muestra a continuación.
...
Y a continuación, se muestra el mapa marcando la diferencia con los 5 mejores departamentos en terminos del puntaje medio obtenido en la prueba de matematicas
